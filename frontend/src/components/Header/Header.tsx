...
export default function Header() {
  ...
  const { likes, cart } = useSelector((state) => state.appSlice);
  ...
  return (
    <header className="header">
      <div className="header__container">
        ...
        <Link
          className="header__nav-link header__button"
          to={`/find?${new URLSearchParams({ gender: 'female' }).toString()}`}
        >
          Для неё
        </Link>
      </div>
      ...
      <nav className="header__navigation">
        ...
        <Link className="header__nav-link header__nav-link_heart" to={'/likes'}>
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
            height="1em"
        ...
        <Link to={'/cart'} className="header__nav-link header__nav-link_cart">
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
            height="1em"
