...
export default async function AboutOrder() {
  ...
  return (
    <AboutPage>
      ...
      />
      <p className="AboutOrder__text">
        В случае, если размер есть в наличии и его можно заказать, вы вносите предоплату 100%. Дальше вещь едет на фотосклад, там будет сделан подробный фотоотчет с замерами, который вы получите в личные сообщения:
      </p>
      ...
      />
      <p className="AboutOrder__text">
      Далее мы отправляем вам ваши вещи сдэком или любой другой удобной для вас транспортной компанией. Мы работаем честно, скоро нашему магазину будет уже 4 года, на протяжении всего этого времени у нас есть честные отзывы на авито и уже собралась не маленькая база постоянных покупателей. Так же у нас есть наличие в Санкт-Петербурге, посмотреть его можно тут {" "}
        <a
