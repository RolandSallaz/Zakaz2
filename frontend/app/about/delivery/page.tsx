...
export default function page() {
  return (
    <AboutPage>
      ...
      <p className="AboutOrder__text">
        ‼️Внимание‼️
        Срок доставки указан с момента отправки вещей со склада в Китае, после того, как вы подтвердите вещь на фотоотчете. Срок доставки ориентировочный, уточняйте состояние доставки перед заказом.
      </p>
    </AboutPage>
  );
}
