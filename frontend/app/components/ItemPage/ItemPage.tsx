...
export default function ItemPage({ item }: props) {
  ...
  function makeLinksClickable(text: string) {
    ...
    const textWithLinks = text.replace(linkRegex, (url) => {
      return `<a class="link ItemPage__link" href="${url}" target="_blank" rel="noopener noreferrer">${url.replace(
        /(http)s?:\/\//gi,
        ""
      )}</a>`;
    });
    ...
    <main className="main ItemPage">
      <div className="ItemPage__container ItemPage__container_left">
        <div className="ItemPage__container ItemPage__container_name">
          ...
          {!isMobile && (
            <button
              className={`ItemPage__button ItemPage__button_favorite ${
                isItemLiked && "ItemPage__button_favorite_active"
              }`}
              ...
              <SwiperSlide key={index} virtualIndex={index}>
                <img
                  ...
                  className={`ItemPage__image ${
                    image == activeImage && "ItemPage__image_active"
                  }`}
                  id={image}
                  src={image}
        ...
        <div className="ItemPage__button-container">
          <button
            className={`ItemPage__button ${
              isItemInCart
                ? "ItemPage__button_purple"
                : "ItemPage__button_green"
            }`}
