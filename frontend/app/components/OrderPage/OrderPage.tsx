...
import { removeFromCart, openInfoPopup } from "@/app/lib/redux/slices/appSlice";
import { useAppDispatch } from "@/app/lib/redux/store";
import { ApiGetActualItemsInfo, ApiSendOrder } from "@/app/lib/utils/api";
import { IItem, IOrderDto } from "@/app/lib/utils/types";
import { getProductText } from "@/app/lib/utils/utils";
        ...
        <form className="OrderPage__form" onSubmit={handleSubmit(onSubmit)}>
          <div className="OrderPage__column">
            <label className="OrderPage__input-label">
              <input
                className={`OrderPage__input ${
                  errors.telegram && "OrderPage__input_error"
                }`}
            ...
            <label className="OrderPage__input-label">
              <input
                className={`OrderPage__input ${
                  errors.phone && "OrderPage__input_error"
                }`}
